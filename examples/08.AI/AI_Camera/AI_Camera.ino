...
// กำหนด ID จากหน้ากล่องที่ได้รับ
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  // การกำหนดเงื่อนไข สามารถกำหนดได้ตามตามความต้องการ แต่ต้องเริ่มจาก 2 โมเดลหรือมากกว่าเป็นต้นไป
  // เงื่อนไขต้องสอดคล้องกับโมเดลที่เทรนจาก google teachable machine
